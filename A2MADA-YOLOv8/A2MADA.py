...
def extract_layer_outputs(captured_outputs):
    # 提取特定层的输出
    layer_5_output = captured_outputs.get(5, None)
    layer_7_output = captured_outputs.get(7, None)
    layer_9_output = captured_outputs.get(9, None)
    ...
    return layer_5_output, layer_7_output, layer_9_output, layer_15_output, layer_18_output, layer_21_output
